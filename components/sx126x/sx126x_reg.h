...
enum SX126xAfcFei : uint8_t {
  AFC_AUTO_CLEAR_ON = 0x01,
};

enum SX126xPreambleDetect : uint8_t {
...
enum SX126xPacketConfig1 : uint8_t {
  CRC_ON = 0x10,
  CRC_OFF = 0x00,
};

enum SX126xPacketConfig2 : uint8_t {
  CONTINUOUS_MODE = 0x00,
  PACKET_MODE = 0x40,
};

enum SX126xFifoThresh : uint8_t {
  TX_START_FIFO_EMPTY = 0x80,
  TX_START_FIFO_LEVEL = 0x00,
};

enum SX126xImageCal : uint8_t {
